document.addEventListener('DOMContentLoaded', () => {
    const imageContainer = document.getElementById('cupcake-images');
    const totalImages = 12;
    const startingRow = 1;
    const possibleExtensions = ['png', 'jpg', 'jpeg', 'webp', 'gif'];
    const fallbackImage = '../images/cupcakes/cupcake-img1.png';
    ...
    function findValidImage(index) {
      return new Promise((resolve) => {
        ...
        const tryNext = () => {
          ...
          const path = `../images/cupcakes/cupcake-img${index}.${ext}`;
