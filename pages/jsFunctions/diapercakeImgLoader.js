document.addEventListener('DOMContentLoaded', () => {
    const imageContainer = document.getElementById('diapercake-images');
    const totalImages = 5;
    const startingRow = 1;
    const possibleExtensions = ['png', 'jpeg', 'jpg', 'webp', 'gif'];
    ...
    function findValidImage(index) {
      return new Promise((resolve) => {
        ...
        const tryNext = () => {
          ...
          const path = `../images/diapercakes/diapercake-img${index}.${ext}`;
